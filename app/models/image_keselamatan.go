...
type ImageKeselamatan struct {
	...
	FileImageID           uint8               `json:"file_image_id" gorm:"default:not null" column:"file_image_id"`
	FileImage             FileImage           `gorm:"foreignKey:FileImageID;references:IdFileImage"`
	KejadianKeselamatanID uint8               `json:"kejadian_keselamatan_id" gorm:"default:not null" column:"kejadian_keselamatan_id"`
